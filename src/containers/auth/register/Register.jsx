...
import { setError } from '../../../redux/ui/actions';
import { createUserWithEmailAndPassword } from '../../../redux/auth/action';
  ...
  return (
    <div className="card auth__card animate__animated animate__fadeIn">
      <div className="card-body">
        ...
        <form className="mb-4" onSubmit={handleRegister}>
          ...
          <div className="form-group">
            ...
            <input type="password" className="form-control" value={password2}
              id="password2" name="password2" onChange={handleInputChange}/>
          </div>
        ...
        <p>Have you account? <Link to="/auth/login">Sign In</Link></p>
      </div>
    </div>
  )
}
